define(require => {
    ...
    class Segment extends PIXI.Container {
        constructor(data) {
            ...
            this.winHighlight.x = -10;
            this.winHighlight.y = 4.5;

            this.text = new Text("");
            this.sprite = new PIXI.Sprite(PIXI.Texture.EMPTY);
            this.sprite.rotation = Math.PI / 2;
            this.prize = 0;
            this.text.maxWidth = 115;
        ...
        land() {
            ...
            msgBus.publish('Game.SetBonusWinValues',{game:'wheel',value:this.prize});
            msgBus.publish('Game.Wheel.Land', this.prize);
