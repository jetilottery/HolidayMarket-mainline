define(require => {
    ...
    class NumberCard extends Pressable {
        constructor() {
            ...
            this.highlightFX.y = 105;
            this.highlightFX.x = -2;
            this.highlightFX.renderable = false;
        ...
        initSpine() {
            ...
            _this.spineAnim.state.setAnimation(0, 'YourNumber_STATIC', false);
        ...
        async uncover() {
            await new Promise(resolve => {
                ...
                setTimeout(() => {
                    ...
                    this.highlightFX.renderable = true;
                    this.addText();
                }, symbolRevealDelay);
