define(require => {
    ...
    function init() {
        // Page 1
        let bonusCoin1 = PIXI.Texture.fromFrame('bonusCoinLarge');
        ...
        bonusCoin1.scale.set(0.15);
        bonusCoin1.x = - smlCoinSize * 0.8;
        let bonusCoin2 = PIXI.Texture.fromFrame('bonusWheelCoinLarge');
